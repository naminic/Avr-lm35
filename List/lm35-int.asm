...
_0x0:
	.DB  0x25,0x73,0x20,0xDF,0x43,0x0,0x54,0x68
	.DB  0x65,0x20,0x74,0x65,0x6D,0x70,0x20,0x69
	.DB  0x73,0x3A,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2040060:
...
; 0000 0030          ftoa(adc_data,1,init_temp);
	...
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(_init_temp)
	LDI  R27,HIGH(_init_temp)
	CALL _ftoa
; 0000 0031          sprintf(lcd_temp,"%s \xdfC",init_temp);
	LDI  R30,LOW(_lcd_temp)
	LDI  R31,HIGH(_lcd_temp)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
	ST   -Y,R30
	LDI  R30,LOW(_init_temp)
	LDI  R31,HIGH(_init_temp)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDI  R24,4
...
; 0000 0037          lcd_puts(lcd_temp);
	LDI  R26,LOW(_lcd_temp)
	LDI  R27,HIGH(_lcd_temp)
	RCALL _lcd_puts
; 0000 0038       }
	RJMP _0x3
; 0000 0039 }
